...
```{exercise}
Considere o seguinte jogo. Em uma baralho comum de 52 cartas, com quatro naipes (copas, ouro, espada e paus), você escolhe ua carta ao acaso e ganha 10 reais se for de copas. Se tirar um Valete, Dama ou Rei que não seja de copas, você ganha 8. Qualquer outra carta, perde 4. Calcule o valor esperado do jogo.
```
