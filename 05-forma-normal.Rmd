...
3. Como a combinação de cada ação de todas as jogadoras afetam qual resultado irá acontecer e se materializar, e
...
3. $v_1: \{\text{(Confessa, Confessa), (Confessa, não-confessa), (não-confessa, confessa), (não-confessa, confessa)}\} \to R$.
...
\begin{cases}
    ...
    10 & \text{if }~~ Não-confessa,Confessa \\
    2& \text{otherwise.}
\end{cases}
\end{equation}
