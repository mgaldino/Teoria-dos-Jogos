...
Antes, vamso explicar os conceitos de supremo e ínfimo. Se um máximo existir, então ele é um supremo. Se um mínimo existir, então ele é um ínfimo. Considere o conjunto dos números reais maiores que zero e menores que 1. Não existe mínimo nem máximo. Porém, existem ínfimos e supremos. $0$ é o ínfimo, e $1$ é o supremo.
